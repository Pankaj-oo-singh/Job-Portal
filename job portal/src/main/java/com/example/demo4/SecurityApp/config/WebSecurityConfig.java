...
public class WebSecurityConfig {
    ...
    private static final String[] publicRoutes = {
            "/error", "/auth/**", "/home.html","/profile/me", "/error",
            "/auth/**",
            "/home.html",
            "/profile/**",
            "/uploads/**",
...
//                        .requestMatchers("/job/apply/**").authenticated()
//                        .requestMatchers("/job/applied").authenticated()
                        .requestMatchers("/job/applicant/{id}/status").authenticated()
                        .requestMatchers("/profile/upload-photo").authenticated()
